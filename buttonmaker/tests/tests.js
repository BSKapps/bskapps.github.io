import { state, defaultDesign, defaultTextLayer, deepClone } from '../js/state.js?v=16';
import { seriesVariants, safeFileName } from '../js/series.js?v=16';
import { buildCompanionPage } from '../js/companion.js?v=16';
import { renderToDataUrl } from '../js/renderer.js?v=16';
