import { state, defaultDesign, defaultTextLayer, deepClone } from '../js/state.js?v=8';
import { seriesVariants, safeFileName } from '../js/series.js?v=8';
import { buildCompanionPage } from '../js/companion.js?v=8';
import { renderToDataUrl } from '../js/renderer.js?v=8';
