import { state, defaultDesign, defaultTextLayer, deepClone } from '../js/state.js?v=15';
import { seriesVariants, safeFileName } from '../js/series.js?v=15';
import { buildCompanionPage } from '../js/companion.js?v=15';
import { renderToDataUrl } from '../js/renderer.js?v=15';
