...
import { renderToDataUrl } from './renderer.js?v=4';
import { seriesVariants, safeFileName } from './series.js?v=4';
import { downloadBlob } from './presets.js?v=4';
import { buildCompanionPage } from './companion.js?v=4';
