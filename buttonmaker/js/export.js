...
import { renderToDataUrl } from './renderer.js?v=42';
import { seriesVariants, safeFileName } from './series.js?v=42';
import { downloadBlob } from './presets.js?v=42';
import { buildCompanionPage } from './companion.js?v=42';
