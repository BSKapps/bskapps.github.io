...
import { renderToDataUrl } from './renderer.js?v=45';
import { seriesVariants, safeFileName } from './series.js?v=45';
import { downloadBlob } from './presets.js?v=45';
import { buildCompanionPage } from './companion.js?v=45';
