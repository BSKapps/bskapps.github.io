...
import { renderToDataUrl } from './renderer.js?v=47';
import { seriesVariants, safeFileName } from './series.js?v=47';
import { downloadBlob } from './presets.js?v=47';
import { buildCompanionPage } from './companion.js?v=47';
