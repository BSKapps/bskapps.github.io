...
import { renderToDataUrl } from './renderer.js?v=2';
import { seriesVariants, safeFileName } from './series.js?v=2';
import { downloadBlob } from './presets.js?v=2';
import { buildCompanionPage } from './companion.js?v=2';
