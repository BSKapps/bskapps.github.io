...
import { renderToDataUrl } from './renderer.js?v=36';
import { seriesVariants, safeFileName } from './series.js?v=36';
import { downloadBlob } from './presets.js?v=36';
import { buildCompanionPage } from './companion.js?v=36';
