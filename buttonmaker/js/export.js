...
import { renderToDataUrl } from './renderer.js?v=48';
import { seriesVariants, safeFileName } from './series.js?v=48';
import { downloadBlob } from './presets.js?v=48';
import { buildCompanionPage } from './companion.js?v=48';
