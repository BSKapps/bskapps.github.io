...
import { renderToDataUrl } from './renderer.js?v=8';
import { seriesVariants, safeFileName } from './series.js?v=8';
import { downloadBlob } from './presets.js?v=8';
import { buildCompanionPage } from './companion.js?v=8';
