...
import { renderToDataUrl } from './renderer.js?v=30';
import { seriesVariants, safeFileName } from './series.js?v=30';
import { downloadBlob } from './presets.js?v=30';
import { buildCompanionPage } from './companion.js?v=30';
