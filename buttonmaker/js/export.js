...
import { renderToDataUrl } from './renderer.js?v=5';
import { seriesVariants, safeFileName } from './series.js?v=5';
import { downloadBlob } from './presets.js?v=5';
import { buildCompanionPage } from './companion.js?v=5';
