...
import { renderToDataUrl } from './renderer.js?v=40';
import { seriesVariants, safeFileName } from './series.js?v=40';
import { downloadBlob } from './presets.js?v=40';
import { buildCompanionPage } from './companion.js?v=40';
