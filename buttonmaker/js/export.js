...
import { renderToDataUrl } from './renderer.js?v=33';
import { seriesVariants, safeFileName } from './series.js?v=33';
import { downloadBlob } from './presets.js?v=33';
import { buildCompanionPage } from './companion.js?v=33';
