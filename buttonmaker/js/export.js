...
import { renderToDataUrl } from './renderer.js?v=32';
import { seriesVariants, safeFileName } from './series.js?v=32';
import { downloadBlob } from './presets.js?v=32';
import { buildCompanionPage } from './companion.js?v=32';
