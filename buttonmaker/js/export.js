...
import { renderToDataUrl } from './renderer.js?v=35';
import { seriesVariants, safeFileName } from './series.js?v=35';
import { downloadBlob } from './presets.js?v=35';
import { buildCompanionPage } from './companion.js?v=35';
