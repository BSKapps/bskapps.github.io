...
import { renderToDataUrl } from './renderer.js?v=41';
import { seriesVariants, safeFileName } from './series.js?v=41';
import { downloadBlob } from './presets.js?v=41';
import { buildCompanionPage } from './companion.js?v=41';
