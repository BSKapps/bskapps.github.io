...
import { renderToDataUrl } from './renderer.js?v=49';
import { seriesVariants, safeFileName } from './series.js?v=49';
import { downloadBlob } from './presets.js?v=49';
import { buildCompanionPage } from './companion.js?v=49';
