...
import { renderToDataUrl } from './renderer.js?v=38';
import { seriesVariants, safeFileName } from './series.js?v=38';
import { downloadBlob } from './presets.js?v=38';
import { buildCompanionPage } from './companion.js?v=38';
