...
import { renderToDataUrl } from './renderer.js?v=37';
import { seriesVariants, safeFileName } from './series.js?v=37';
import { downloadBlob } from './presets.js?v=37';
import { buildCompanionPage } from './companion.js?v=37';
