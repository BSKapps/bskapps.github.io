...
import { renderToDataUrl } from './renderer.js?v=39';
import { seriesVariants, safeFileName } from './series.js?v=39';
import { downloadBlob } from './presets.js?v=39';
import { buildCompanionPage } from './companion.js?v=39';
