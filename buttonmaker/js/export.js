...
import { renderToDataUrl } from './renderer.js?v=3';
import { seriesVariants, safeFileName } from './series.js?v=3';
import { downloadBlob } from './presets.js?v=3';
import { buildCompanionPage } from './companion.js?v=3';
